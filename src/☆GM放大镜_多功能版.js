...
const medalData = [
    ...
    },
    {
        ...
        "levels": "【 Max 】1% 回帖咒术+1",
        "levels_img": {
            "Max": ["https://img.gamemale.com/album/202608/03/155551s8adzvg4cqaiiqw4.gif", 124]
        }
    },
    {
        "type": "剧情",
        ...
        "name": "『英勇赞美诗』",
        "date": "2026-7-19",
        "buy_limit": "授予给默默守护论坛和平的勇士们",
        "price": "无",
        "levels": "【 Max 】无属性",
        "levels_img": {
            "Max": ["https://img.gamemale.com/album/202504/05/180536tqesccateezkxct7.gif", 40]
        }
    },
    {
        "type": "奖品",
        ...
        "name": "GM村蛋糕(New)",
        "date": "2026-7-19",
        "buy_limit": "在生日当天或前一天进行登记<a href=\"/thread-80501-1-1.html\" target=\"_blank\">【长期有效】生日蛋糕登记处</a>",
        "price": "无",
        "duration": "1天",
        "levels": "【等级1】无属性▕▏升级条件：消耗-50金币\n【 Max 】50% 回帖金币+1 血液+1",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "无",
        "price": "300金币",
        "levels": "【等级1】1% 回帖金币+1▕▏升级条件：消耗200血液\n【等级2】2% 回帖金币+2 咒术+1▕▏升级条件：消耗200金币\n【等级3】30% 回帖堕落+1▕▏升级条件：知识≥5\n【等级4】4% 回帖金币+2 咒术+1▕▏升级条件：知识≥88\n【 Max 】6% 回帖金币+2 咒术+1",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "追随≥10",
        "price": "666金币",
        "levels": "【等级1】3% 回帖咒术+1、发帖咒术+1▕▏升级条件：消耗100金币\n【等级2】5% 回帖咒术+1 金币+1、发帖金币+1 咒术+1▕▏升级条件：消耗20咒术\n【 Max 】7% 回帖咒术+1 金币+2、发帖金币+2 咒术+1",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "旅程≥20",
        "price": "560金币",
        "levels": "【等级1】2% 回帖咒术+1▕▏升级条件：追随≥33\n【等级2】4% 回帖咒术+1 血液+1▕▏升级条件：消耗88咒术\n【等级3】5% 回帖咒术+1 血液+1▕▏升级条件：消耗360血液\n【 Max 】8% 回帖咒术+1 血液+2",
        "levels_img": {
    ...
    },
    {
        ...
        "name": "巴比伦辞典",
        "date": "2024-5-26",
        "buy_limit": "<a href=\"/thread-180869-1-1.html\" target=\"_blank\">单机游戏区激励活动（点击跳转）</a>",
        "price": "不可购买",
    ...
    },
    {
        ...
        "buy_limit": "追随≥20",
        "price": "400金币",
        "levels": "【等级1】4% 回帖血液+1、发帖咒术+1▕▏升级条件：消耗233血液\n【等级2】5% 回帖血液+1 咒术+1、发帖咒术+1▕▏升级条件：消耗233金币\n【等级3】6% 回帖血液+1 咒术+1、发帖咒术+1▕▏升级条件：消耗66咒术\n【等级4】7% 回帖血液+2 咒术+1、发帖旅程+1▕▏升级条件：旅程≥80\n【 Max 】8% 回帖血液+3 咒术+1、发帖旅程+1",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "知识≥1",
        "price": "200金币",
        "levels": "【等级1】8% 回帖咒术+1 金币-1、发帖金币+1▕▏升级条件：消耗100血液\n【等级2】10% 回帖咒术+1 血液-1、发帖咒术+1▕▏升级条件：消耗100金币\n【 Max 】8% 回帖咒术+1、发帖知识+1",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "旅程≥15",
        "price": "500金币",
        "levels": "【等级1】4% 回帖金币+1 血液+1、发帖金币+1 血液+1▕▏升级条件：消耗200金币\n【等级2】6% 回帖金币+1 血液+1、发帖金币+1 血液+1▕▏升级条件：消耗200血液\n【等级3】8% 回帖金币+2 血液+1、发帖金币+2 血液+1▕▏升级条件：消耗50咒术\n【等级4】3% 回帖金币+1 血液+1 旅程+1、发帖金币+1 血液+1 旅程+1▕▏升级条件：知识≥50\n【等级5】4% 回帖金币+2 血液+1 旅程+1、发帖金币+2 血液+1 旅程+1▕▏升级条件：知识≥120\n【 Max 】4% 回帖金币+3 血液+1 旅程+1、发帖金币+3 血液+1 旅程+1",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "无",
        "price": "400金币",
        "levels": "【等级1】3% 回帖堕落-1▕▏升级条件：追随≥70\n【等级2】7% 回帖血液+1 堕落-1、发帖血液+1▕▏升级条件：消耗300金币\n【等级3】10% 回帖血液+1 金币+1、发帖血液+1 金币+1▕▏升级条件：血液≥700\n【 Max 】17% 回帖血液+1 金币+1、发帖血液+2 金币+2",
        "levels_img": {
    ...
    },
    {
        ...
        "buy_limit": "旅程≥12",
        "price": "180金币",
        "levels": "【等级1】2% 回帖旅程+1▕▏升级条件：消耗30咒术\n【等级2】2% 回帖旅程+1 知识+1、发帖知识+1 旅程+1▕▏升级条件：消耗50咒术\n【 Max 】3% 回帖旅程+1 知识+1、发帖知识+1 旅程+1",
        "levels_img": {
    ...
    class IdbStorageManager {
                    ...
                    this.storesConfig.forEach((cfg) => {
                        if (!db.objectStoreNames.contains(cfg.name)) {
                            const store = db.createObjectStore(
                                cfg.name,
                                cfg.options || { keyPath: "id", autoIncrement: true },
                            );
        ...
        model(storeName) {
            ...
            return {
                 ...
                 */
                add: (record) =>
                    this.#execute(storeName, "readwrite", (s) => s.add(record)),
                /**
                 * 批量添加数据
                 */
                addBatch: (records) => {
                    return this.#execute(storeName, "readwrite", (store, tx) => {
                        return new Promise((resolve, reject) => {
                            ...
                            tx.oncomplete = () =>
                                resolve({ count: total, status: "success" });
                            tx.onabort = () =>
                                reject(new Error("事务被中止 (Transaction Aborted)"));
                            tx.onerror = () => reject(tx.error);
                        });
                    });
                },
                 ...
                 */
                update: (record) =>
                    this.#execute(storeName, "readwrite", (s) => s.put(record)),
                /**
                 * 删除数据
                 */
        ...
        stores: [
            {
                ...
                indexes: [
                    { name: "idx_name_cleansing", keyPath: "name_cleansing" },
    ...
    class ControlPanel {
        ...
        _CommonRender() {
            ...
            Object.keys(this.tabRegistry).forEach((key) => {
                ...
                btn.dataset.tab = key;
                btn.innerHTML =
                    this.tabRegistry[key].icon + this.tabRegistry[key].label;
        ...
        _bindBasicEvents() {
            const isLocalImgEnabled =
                typeof window.showDirectoryPicker === "function";
            const magnifierCard = this.shadow.querySelector(".magnifier");
            const magnifierSwitch = magnifierCard.querySelector(
                'input[type="checkbox"]',
            );
            ...
            const imageLocalSwitch = imageLocalCard.querySelector(
                'input[type="checkbox"]',
            );
            ...
            magnifierSwitch.onchange = (e) => {
                ...
                imageCard.classList.toggle(
                    "disabled",
                    !(checked && isimageSwitchChecked),
                );

                if (isLocalImgEnabled) {
                    const isimageLocalSwitchChecked = imageLocalSwitch.checked;
                    imageLocalCard.classList.toggle(
                        "disabled",
                        !(checked && isimageLocalSwitchChecked),
                    );
                    selectDirCard.classList.toggle(
                        "disabled",
                        !(checked && isimageLocalSwitchChecked),
                    );
                }
            ...
            dropListItems.forEach((item) => {
                item.onclick = () => {
                    ...
                    if (oldSelect !== item.innerText) {
                        ...
                        this.toast.show({
                            type: "success",
                            msg: "定位模式已成功切换到：" + item.innerText,
                        });
                    } else {
                        this.toast.show({
                            type: "info",
                            msg: "当前定位模式已经是：" + item.innerText,
                        });
                    }
                    if (!isMagnifierOpen)
                        this.toast.show({
                            type: "error",
                            msg: "定位模式未生效，请先开启勋章放大镜镜！",
                        });
                };
            });
            ...
            imageSwitch.onchange = (e) => {
                ...
                isLocalImgEnabled &&
                    imageLocalCard.classList.toggle(
                        "disabled",
                        !(isMagnifierOpen && isImageLocalChecked && checked),
                    );
                isLocalImgEnabled &&
                    selectDirCard.classList.toggle(
                        "disabled",
                ...
                this.toast.show({
                    ...
                    msg: "显示图片已" + (checked ? "开启" : "关闭"),
                });
                if (!isMagnifierOpen && checked)
                    this.toast.show({
                        type: "error",
                        msg: "无法显示图片，请先开启勋章放大镜镜！",
                    });
            };
            if (!isLocalImgEnabled) {
            ...
            imageLocalSwitch.onchange = (e) => {
                ...
                imageLocalCard.classList.toggle(
                    "disabled",
                    !(isMagnifierOpen && isimageSwitchChecked && checked),
                );
                selectDirCard.classList.toggle(
                    "disabled",
                    !(isMagnifierOpen && isimageSwitchChecked && checked),
            ...
            selectDirBtn.onclick = async () => {
                ...
                try {
                    if (await this.localFile.authorize()) {
                        ...
                        selectDirCard.querySelector(".card-desc").textContent =
                            "已授权文件夹：" + name;
            ...
            const stopRecording = () => {
                ...
                this.toast.show({
                    type: "info",
                    msg: `快捷键修改已退出，当前为: ${this.data.basic.shortcut || "Alt + S"}`,
                });
        ...
        _getWeightHTML() {
            const weightEntries = Object.entries(this.data.weights)
                .map(([k, v]) => {
                    return `
        ...
        _getAboutHTML() {
            ...
            `,
                    ...
                    .join("") +
                `<div style="padding-left: 16px; line-height: 1;">第三方网站</div>` +
                ControlPanel.linkData
                    .map(
                        (item) => `
                <div class="card">
                    <div class="card-body">
        ...
        _BindCommonEvents() {
            ...
            navThemeEl.onclick = () => {
                const nextTheme =
                    this.data.theme.magnifierTheme === "light" ? "dark" : "light";
        ...
        hide() {
            ...
            if (
                ...
                JSON.stringify(JSON.parse(localStorage.getItem(this.storageKey)))
            )
                this._saveData();
    ...
    const util = (managerRef) => {
         ...
         * 名称只保留数字、中文、英文、『』
         */
        const name_cleansing = (str) =>
            str.replace(/[^a-zA-Z0-9『』\p{Unified_Ideograph}]/gu, "");
        /**
         * 名称模糊查询变体（去重）
         */
    ...
    const createConvertLEVELS = (utilInstance) => {
        ...
        const parse = {
            ...
            BuyPrice: (buy_price) => {
                ...
                return m
                    ? utilInstance.toNumber(m[1]) * utilInstance.getWeight(m[2])
                    : parseInt(buy_price, 10) || 0;
            },
            ...
            Upgrade: (line = "") => {
                ...
                if ((m = expr.match(RE_COST_1)) || (m = expr.match(RE_COST_2))) {
                ...
                // 匹配：属性 >= 100
                if ((m = expr.match(RE_COND_1)) || (m = expr.match(RE_COND_2))) {
        ...
        const compute = {
            ...
            UpgradeCost: (levelsObj) => {
                ...
                for (const lvl of Object.keys(levelsObj)) {
                    ...
                    if (upgrade.type === "消耗") {
                        consumedItems[upgrade.item] =
                            (consumedItems[upgrade.item] ?? 0) + upgrade.cost;
                        consumedTotal +=
                            upgrade.cost * utilInstance.getWeight(upgrade.item);
            ...
            LevelsRaw: (levelsObj) => {
                return Object.fromEntries(
                    Object.entries(levelsObj).map(([k, v]) => {
                        ...
                        const rateHTML = rate
                            ? `<span class="medal-rate">${parseInt(rate * 100)}%</span>`
                            : '<span class="medal-rate">0%</span>';
                        const replayHTML =
                            replay && Object.keys(replay).length
                                ? `<span class="medal-replay">回帖${Object.entries(replay)
                                    .map(([rk, rv]) => utilInstance.formatAward(rk, rv))
                                    .join(" ")}</span>`
                                : "";
                        const postHTML =
                            post && Object.keys(post).length
                                ? `<span class="medal-post">发帖${Object.entries(post)
                                    .map(([pk, pv]) => utilInstance.formatAward(pk, pv))
                                    .join(" ")}</span>`
                                : "";
            ...
            CostInfo: (levelsObj, buy_price, BeatLv, MaxLv) => {
                ...
                const renderLvl = (lvl, award, isMaxHeader = false) => {
                    ...
                    const costHtml = Object.entries(consumes)
                        .map(
                            ([k, v]) =>
                                `<span style="color:${ATTR_MAP?.[k]?.color || ""}">${v}${k}</span>`,
                        )
                        .join("、");
        ...
        const AllToHTML = (levelsStr, imgsObj, buy_price) => {
            ...
            // 排序与拼接
            const toNum = (v) =>
                v === "初级" ? -Infinity : v === "Max" ? Infinity : Number(v);

            const levelsHTML = Object.keys(levelsObj)
                .sort((a, b) => toNum(a) - toNum(b))
                .map((key) => {
                    const title =
                        key === "Max" || key === "初级" ? `${key}` : `等级${key}`;
    ...
    class LocalFileSystem {
        ...
        async #saveHandle(handle) {
            try {
                this.idb
                    ...
                    .updateByField("idx_name", this.recordName, {
        ...
        async #getHandle() {
            try {
                const results = await this.idb
                    .model(this.storeName)
                    .query({ index: "idx_name", value: this.recordName });
    ...
    class MedalMagnifier {
        ...
        initDB() {
            ...
            (async () => {
                ...
                if (num !== c) {
                    ...
                    const sortedDataNoTid = [...this.medalDataNoTid].map((a) => ({
                        ...a,
                        name_cleansing: this.utilFunc.name_cleansing(a.name),
                        levels: this.convertFunc.parse(a.levels),
                    }));
                    ...
                    const c = await idbstorage.model("award_info").count();
                    console.log(
                        `award_info数据库表，插入条数：${c}（博物馆：${m_count}；非博物馆${mNo_count}）`,
                    );
                }
            })();
        }
        ...
        generateTemplate(item) {
            const noText = item?.no
                ? `<span style="font-size:18px">No.</span><span class="medal-no">${item.no}</span >`
                : "";
            const typeText = item?.type
                ? `<span class="medal-type">${item.type}</span>`
                : "";
            const nameText = item?.name
                ? `<span class="medal-name">${item.name}</span>`
                : "";
            const backstoryText = item?.backstory
                ? `<span class="medal-backstory">【背景故事】${item.backstory}</span>`
                : "";
            const tidText =
                item?.date && item?.url_tid
                    ? `<span class="medal-create">【创建时间】<a href="/thread-${item.url_tid}-1-1.html" target="_blank">${item.date}（前往博物馆）</a></span>`
                    : item?.date
                        ? `<span class="medal-create">【创建时间】${item.date}</span>`
                        : "";
            const buyLimitText =
                item?.buy_limit && item?.buy_limit !== "无"
                    ? `<span class="medal-buyLimit">【购买条件】${item.buy_limit}</span>`
                    : "";
            const priceText = item?.price
                ? `<span class="medal-price">【商店售价】${item.price}</span>`
                : "";
            const durationText = item?.duration
                ? `<span class="medal-duration">【持续时间】${item.duration}</span>`
                : "";
            // 处理item.levels内容，加上img和回帖概率以小数显示
            const levelsALLHTML = this.convertFunc.AllToHTML(
                item?.levels,
                this.showImg ? item?.levels_img_local : "",
                item?.price,
            );
        ...
        async show(targetEL, type = "name", typeValue, position = "default") {
            ...
            if (
                position === "saltfish" &&
                (!(await this.localFile.verify()) || !this.getLocalImgStatus())
            )
                this.showImg = false; // 跨域问题无法显示图片
            ...
            if (items.length > 1) {
                ...
                for (let i = 1; i < items.length; i++) {
                    ...
                    items[i].levels_img_local = await this.getLocalImg(
                        items[i].levels_img,
                    );
                    ...
                    let side = "left";
                    if (
                        document.querySelector("#rank-info-window").getBoundingClientRect()
                            .left >
                        windowHeight / 2
                    )
                        side = "right";
                    ...
                    if (side === "left") left = lastRect.left + "px";
                        ...
                        left = lastRect.right - subEl.offsetWidth + "px";
                    }
                    // 最终应用正确位置
                    Object.assign(subEl.style, {
                        left: left,
        ...
        positionRank(target) {
            ...
            const w = document
                .querySelector("#rank-info-window")
                .getBoundingClientRect().width; // 标题栏的宽度
        ...
        positionSaltfish(target) {
            ...
            if (left < 0) {
                if (rightAvailableWidth > 0) left = targetLeft + targetWidth;
                    ...
                    left = 2;
                    this.el.style.width = targetLeft - 4 + "px";
                    // 重新获取放大镜的高度(包含滚动条)
                    h = this.el.offsetHeight;
                }
            }
        ...
        initAllBindListen() {
            ...
            this.bindConfigs = [
                ...
                },
                {
                    ...
                    delay: 150,
                    getId: (el) =>
                        el.querySelector(".rank-info-name")?.textContent?.trim(),
                },
                {
                    type: "saltfish",
            ...
            // 动态生成全局点击过滤的选择器串
            const allTargetsSelector = this.bindConfigs
                .map((c) => c.target)
                .join(", ");
            ...
            this.bindConfigs.forEach((conf) => {
                const tryBind = () => {
                    ...
                    container.addEventListener("pointerover", (event) => {
                        ...
                        if (
                            !targetEl ||
                            (event.relatedTarget && targetEl.contains(event.relatedTarget))
                        )
                            return;
                        ...
                        hoverTimer = setTimeout(() => {
                            ...
                            if (matchedItem)
                                this.show(targetEl, "item", matchedItem, conf.type);
                            else {
                                this.hide();
